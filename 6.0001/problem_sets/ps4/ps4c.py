...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        """
        # Build initial mapping between lowercase vowels and supplied permutation
        lower_dict = {vowel: permutation for (vowel, permutation) in
                      zip(VOWELS_LOWER, vowels_permutation)}
        transpose_dict = lower_dict.copy()
        # Fill in uppercase vowels
        for vowel in lower_dict:
            transpose_dict[vowel.upper()] = lower_dict[vowel].upper()

        # Fill in unchanged consonants
...
if __name__ == "__main__":
    ...
    message = SubMessage("Hello, fat cat!")
    permutation = "iuoea"
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Expected encryption:", "Hulle, fit cit!")
    print("Actual encryption:", message.apply_transpose(enc_dict))
    enc_message = EncryptedSubMessage(message.apply_transpose(enc_dict))
    print("Decrypted message:", enc_message.decrypt_message())

    message = SubMessage("Hi, muscles!")
    permutation = "uoiae"
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Expected encryption:", "Hi, mesclos!")
    print("Actual encryption:", message.apply_transpose(enc_dict))
    enc_message = EncryptedSubMessage(message.apply_transpose(enc_dict))
    print("Decrypted message:", enc_message.decrypt_message())
