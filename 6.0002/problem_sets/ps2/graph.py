...
class WeightedEdge(Edge):
    """Represents a weighted edge in the dictionary. Includes source, destination,
    total distance along edge and outdoor distance along edge."""
...
class Digraph(object):
    ...
    def add_edge(self, edge):
        ...
        if not (source in self.edges and destination in self.edges):
            raise ValueError("Node not in graph: {}".format(edge))
