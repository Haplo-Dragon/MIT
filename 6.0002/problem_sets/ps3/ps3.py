...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        # Initially, fill all tiles with dirt_amount
...
class Robot(object):
    ...
    def update_position_and_clean(self):
        ...
        rotate once to a random new direction, and stay stationary) and mark the tile it
        is on as having been cleaned by capacity amount.
        """
        # do not change -- implement in subclasses
        raise NotImplementedError
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        y = float(random.randint(0, self.height - 1))
        return Position(x, y)
...
class FurnishedRoom(RectangularRoom):
    ...
    def get_random_position(self):
        """
        Returns: a Position object; a valid random position (inside the room and not in a
        furnished area).
        """
        # There must be a way to avoid repeating myself here, but I'm not seeing it...
...
#     'Time to clean 80% of a 20x20 room, for various numbers of robots',
#     'Number of robots',
#     'Time / steps')
