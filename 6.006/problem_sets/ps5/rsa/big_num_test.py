...
class BigNumTest(unittest.TestCase):
    ...
    def test_addition(self):
        ...
        self.assertEqual(BigNum.h("FEFDFC") + BigNum.h("FBFAF9F8"), BigNum.h("FCF9F7F4"))
    ...
    def test_subtraction(self):
        ...
        self.assertEqual(BigNum.h("4321") - BigNum.h("056789A"), BigNum.h("FFA9CA87"))
    ...
    def test_multiplication(self):
        ...
        self.assertEqual(BigNum.h("1234") * BigNum.h("56789A"), BigNum.h("06260B5348"))
        self.assertEqual(
            BigNum.h("FFFFFF") * BigNum.h("FFFFFF"), BigNum.h("FFFFFE000001")
        )
        self.assertEqual(
            BigNum.h("FEFDFC") * BigNum.h("FBFAF9F8"), BigNum.h("FAFD0318282820")
        )
    ...
    def test_modulo(self):
        ...
        self.assertEqual(BigNum.h("06260FE3C9") % BigNum.h("56789A"), BigNum.h("49081"))
        self.assertEqual(BigNum.h("FFFFFE000001") % BigNum.h("FFFFFF"), BigNum.zero())
        self.assertEqual(BigNum.h("FFFFFE0CFEDC") % BigNum.h("FFFFFF"), BigNum.h("CFEDB"))
        self.assertEqual(BigNum.h("FAFD0318282820") % BigNum.h("FEFDFC"), BigNum.zero())
        self.assertEqual(
            BigNum.h("FAFD0318C3D9EF") % BigNum.h("FEFDFC"), BigNum.h("9BB1CF")
        )

    def test_powmod(self):
        modulo = BigNum.h("100000000")
        self.assertEqual(BigNum.h("42").powmod(BigNum.zero(), modulo), BigNum.one())
        self.assertEqual(BigNum.h("42").powmod(BigNum.one(), modulo), BigNum.h("42"))
        self.assertEqual(BigNum.h("42").powmod(BigNum.h("2"), modulo), BigNum.h("1104"))
        self.assertEqual(
            BigNum.h("42").powmod(BigNum.h("5"), modulo), BigNum.h("4AA51420")
        )
        self.assertEqual(
            BigNum.h("41").powmod(BigNum.h("BECF"), modulo), BigNum.h("C73043C1")
        )
